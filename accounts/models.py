...
class User(AbstractBaseUser):
    ...
    health_worker = models.BooleanField(default=False) #example This is the community health worker
    ...
    def is_health_worker(self):
        """
        Check whether the user is a health worker
        """
        return self.health_worker
